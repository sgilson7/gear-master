...
pub const LADDER: &[MonsterSpec] = &[
    ...
    MonsterSpec {
        ...
        gear: &[
            ...
            ("Godsteel Plating", SlotKind::Helmet, 4, 0, 1),
            ("Overseer's Circlet", SlotKind::Helmet, 0, 2, 0),
            ("Overflow Plate", SlotKind::Helmet, 3, 2, 0),
            ("Godsteel Plating", SlotKind::Helmet, 0, 4, 0),
            ("Overseer's Circlet", SlotKind::Helmet, 3, 4, 0),
            ("Mirrored Visor", SlotKind::Helmet, 1, 5, 2),
            ("Godsteel Plating", SlotKind::Helmet, 3, 6, 2),
            ("The Money Jacket", SlotKind::Chest, 0, 0, 0),
            ("The Green Ledger", SlotKind::Chest, 4, 0, 0),
            ("Bulwark Base", SlotKind::Chest, 0, 3, 0),
            ("The Green Ledger", SlotKind::Chest, 4, 2, 0),
            ("Oathplate", SlotKind::Chest, 4, 4, 0),
            ("Ungloved Layer", SlotKind::Chest, 0, 5, 0),
            ("Heartwood Base", SlotKind::Chest, 2, 5, 1),
            ("The Green Ledger", SlotKind::Chest, 4, 6, 0),
            ("Sevenleague Boots", SlotKind::Gloves, 0, 0, 1),
            ("Sovereign Mold", SlotKind::Gloves, 3, 0, 0),
            ("Sevenleague Boots", SlotKind::Gloves, 0, 2, 1),
            ("Sovereign Mold", SlotKind::Gloves, 3, 1, 3),
            ("Unshod Signet", SlotKind::Gloves, 5, 2, 0),
            ("Hermit's Band", SlotKind::Gloves, 5, 1, 0),
            ("Worldweave Material", SlotKind::Gloves, 4, 3, 1),
            ("Oathkeeper Mold", SlotKind::Gloves, 1, 4, 0),
            ("Ring of Vigils", SlotKind::Gloves, 0, 4, 0),
            ("Hermit's Band", SlotKind::Gloves, 0, 5, 0),
            ("Sevenleague Boots", SlotKind::Greaves, 0, 0, 1),
            ("Deeprooted Sole", SlotKind::Greaves, 3, 0, 0),
            ("Overflow Plate", SlotKind::Greaves, 3, 1, 0),
            ("Sevenleague Boots", SlotKind::Greaves, 0, 2, 1),
            ("Pilgrim Sole", SlotKind::Greaves, 3, 3, 0),
            ("Sevenleague Boots", SlotKind::Greaves, 0, 4, 1),
            ("Deeprooted Sole", SlotKind::Greaves, 3, 5, 0),
            ("Executioner's Haft", SlotKind::Weapon, 0, 0, 1),
            ("Quota Edge", SlotKind::Weapon, 0, 1, 1),
            ("Quota Edge", SlotKind::Weapon, 3, 1, 1),
            ("Bloodstone Bead", SlotKind::Weapon, 0, 2, 0),
            ("Oathstone Bead", SlotKind::Weapon, 2, 2, 0),
        ],
        gear_offset: 0,
        bounty: 500,
        ...
        rank: Rank::Ordinary,
        drops: &[],
        items: &[3, 3, 3, 2, 4, 2, 2, 4, 4, 3, 2, 2, 5],
    },
];
